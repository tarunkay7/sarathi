...
router.post('/session', asyncHandler(async (req, res) => {
  ...
  const { citizenName, dob, vehicleClasses, rto, formNumber, feeRupees, requiresSlot, form1a, checklist, uploads, earliestSlotDate, availableDates, slotTimes } = req.body || {};
